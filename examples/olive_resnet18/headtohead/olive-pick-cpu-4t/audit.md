...
- 1.12x faster at the median on cpu-4t.
- Tail latency improves less: 0.73x at p99 vs 1.12x at p50.
...
|---|---:|---:|---:|
| p50 latency | 14.00 ms | 12.51 ms | 1.12x faster |
| p99 latency | 15.48 ms | 21.27 ms | 0.73x faster |
